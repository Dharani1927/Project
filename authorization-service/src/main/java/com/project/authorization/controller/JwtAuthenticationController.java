...
import com.project.authorization.model.JwtResponse;
import com.project.authorization.model.UserLoginCredential;
import com.project.authorization.model.UserToken;
...
public class JwtAuthenticationController {
	...
	public String login(@RequestBody UserLoginCredential userlogincredentials) throws Exception {
		log.info("START");
		...
		//return new ResponseEntity<>(new UserToken(userlogincredentials.getUserid(), jwtutil.generateToken(userdetails)),HttpStatus.OK);
